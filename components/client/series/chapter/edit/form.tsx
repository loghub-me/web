...
export default function SeriesChapterEditForm({ seriesId, chapterId, form }: Readonly<SeriesChapterEditFormProps>) {
  ...
  return (
    <form id="series-chapter-edit-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
      <TitleField id="series-chapter-edit-form-title" control={form.control} />
      <PublishedField id="series-chapter-edit-form-published" control={form.control} />
      <Controller
