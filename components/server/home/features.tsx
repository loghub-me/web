...
export default function HomeFeaturesSection() {
  ...
  return (
    <section className="mt-16 mx-auto px-8 max-w-6xl space-y-8">
      ...
      <Tabs defaultValue={FEATURES[0].value} className="lg:h-96 flex-col lg:flex-row">
        <TabsList className="p-1.5 lg:max-w-1/3 w-full flex flex-col gap-1 items-center">
