...
export const editQuestion = (questionId: number, json: z.infer<typeof questionEditSchema>) =>
...
export const postAnswer = (questionId: number, json: z.infer<typeof questionAnswerPostSchema>) =>
  clientAPI.post(`questions/${questionId}/answers`, { json }).json<RedirectResponseBody>();

export const editAnswer = (questionId: number, answerId: number, json: z.infer<typeof questionAnswerEditSchema>) =>
