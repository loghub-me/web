  ...
  return (
    <main className="px-4 w-full space-y-8">
      <div className="space-y-2">
        <h2 className="text-2xl font-bold">아티클 작성 가이드</h2>
        <p className="text-muted-foreground">이 페이지는 블로그 아티클 작성 시 참고할 수 있는 가이드를 제공합니다.</p>
        <p className="mt-4">
      ...
      <div className="space-y-2">
        <h2 className="text-2xl font-bold">아티클 검색 가이드</h2>
        <p className="text-muted-foreground">
          이 페이지는 블로그 아티클을 검색할 때 참고할 수 있는 가이드를 제공합니다.
        </p>
        <p className="mt-4">
          Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
          standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        >
          ...
          <div className="space-y-2">
            <h3 className="text-lg font-semibold">아티클 검색</h3>
        ...
        >
          ...
          <div className="space-y-2">
            <h3 className="text-lg font-semibold">아티클 작성</h3>
            <p className="text-muted-foreground whitespace-normal">새로운 아티클을 작성할 수 있습니다.</p>
          </div>
        </ButtonLink>
      </div>
    </main>
