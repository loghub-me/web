  ...
  return (
    <main className="px-4 w-full space-y-8">
      <div className="space-y-2">
        <h2 className="text-2xl font-bold">질문 작성 가이드</h2>
        <p className="text-muted-foreground">이 페이지는 블로그 질문 작성 시 참고할 수 있는 가이드를 제공합니다.</p>
        <p className="mt-4">
      ...
      <div className="space-y-2">
        <h2 className="text-2xl font-bold">질문 검색 가이드</h2>
        <p className="text-muted-foreground">이 페이지는 블로그 질문을 검색할 때 참고할 수 있는 가이드를 제공합니다.</p>
        <p className="mt-4">
          Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
          standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to
          make a type specimen book. It has survived not only five centuries, but also the leap into electronic
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        >
          ...
          <div className="space-y-2">
            <h3 className="text-lg font-semibold">질문 검색</h3>
        ...
        >
          ...
          <div className="space-y-2">
            <h3 className="text-lg font-semibold">질문 작성</h3>
            <p className="text-muted-foreground whitespace-normal">새로운 질문을 작성할 수 있습니다.</p>
          </div>
        </ButtonLink>
      </div>
    </main>
